...
% Um subconjunto das funções de \emph{benchmark} definidas em \cite{dejong1975} foram utilizatas com o objetivo de minimização. Problemas propostos por \cite{dejong1975} como maximização foram convertidos para um problema de minimização. Mais espécificamente, utilizamos a primeira (F1), segunda (F2) e terceira (F3) funções de \cite{dejong1975}.
...
\subsubsection{Representação e Parâmetros} % (fold)
