...
O cruzamento dá-se de forma convencional: considere dois indivíduos $v$ e $q$ e $m$ o tamanho do indivíduo; os indivíduos $z$ e $w$, resultados do cruzamento de $v$ e $q$ serão:
\[
...
\]
Onde $n$ é um valor escolhido de forma aleatória, $ 0 \le n \le m$.
